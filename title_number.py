...
def create_markdown_file_with_number(f,file_name):
    ...
    lines_in_file.insert(1, '''<style>.md-toc {z-index: 999; display: block; position: fixed;left: 6px;top:10px;width:350px;word-wrap: break-word; word-break:break-all; overflow: scroll; } </style>
''')
    f.close()
